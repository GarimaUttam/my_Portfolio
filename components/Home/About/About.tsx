  ...
  return (
    <div className="pt-16 pb-16 bg-[#050709]">
      ...
      <div className="w-[80%] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 items-center mt-20">
        {/* text content*/}
        <div>
          <h1 className="text-bg text-[26px] sm:text-3xl md:text-4xl ld:text-5xl font-bold text-gray-200">
            {aboutInfo.title}
          </h1>
        ...
        {/* Stats Content */}
        <div className="grid grid-cols-2 gap-16 items-ceter lg:mx-auto">
          {/* first stat */}
          <div>
            <Image
